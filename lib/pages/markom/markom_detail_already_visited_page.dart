...
class MarkomDetailAlreadyVisited extends StatelessWidget {
  const MarkomDetailAlreadyVisited({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    Widget header() {
      return CustomAppBar(
        text: "Detail Sudah Datang",
      );
    }
    ...
    Widget informationDate() {
      return CardInformationDate(
        ...
        dateAlreadyVisited: "18 January 2022, 09:18:02",
      );
    }
