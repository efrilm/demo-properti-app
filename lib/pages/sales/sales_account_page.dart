...
class SalesAccountPage extends StatefulWidget {
  const SalesAccountPage({Key? key}) : super(key: key);

  @override
  _SalesAccountPageState createState() => _SalesAccountPageState();
}

class _SalesAccountPageState extends State<SalesAccountPage> {
  var isLoading = false;
